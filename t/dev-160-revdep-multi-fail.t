...
{ # revdep single
    ...
    if ($^O =~ /MSWin/){
        ...
        like ($res[2], qr/\w+::\w+/, "is a module name");
        like ($res[3], qr/5.18.4 :: PASS/, "is a valid result");
        like ($res[4], qr/5.22.1 :: FAIL/, "is a valid result");
        like ($res[5], qr/\w+::\w+/, "is a module name");
        like ($res[6], qr/5.18.4 :: PASS/, "is a valid result");
        like ($res[7], qr/5.22.1 :: FAIL/, "is a valid result");
        like ($res[8], qr/\w+::\w+/, "is a module name");
        like ($res[9], qr/5.18.4 :: PASS/, "is a valid result");
        like ($res[10], qr/5.22.1 :: FAIL/, "is a valid result");
        like ($res[11], qr/\w+::\w+/, "is a module name");
        like ($res[12], qr/5.18.4 :: PASS/, "is a valid result");
        like ($res[13], qr/5.22.1 :: FAIL/, "is a valid result");
    }
