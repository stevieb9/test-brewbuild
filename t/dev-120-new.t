...
{ # --new & -n
    ...
    like ($res[2], qr/5\.\d{2}\.\d :: PASS/, "$res[2] run ok");
    like ($res[3], qr/5\.\d{2}\.\d :: PASS/, "$res[3] run ok");
    like ($res[4], qr/5\.\d{2}\.\d :: PASS/, "$res[4] run ok");
    like ($res[5], qr/5\.\d{2}\.\d :: PASS/, "$res[5] run ok");
    is ($res[6], undef, "no more entries ok");
